...
public class Main {
    public static void main(String[] args) {
        List<Category> categoryList = new ArrayList<>(); // 카테고리 항목 생성
        List<Product> electronics = new ArrayList<>(); // 전자제품을 담을 리스트 생성
        List<Product> clothing = new ArrayList<>(); // 의류를 담을 리스트 생성
        List<Product> foods = new ArrayList<>(); // 식품을 담을 리스트 생성
